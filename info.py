...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001234567898').split()] #for auto index
...
DATABASE_URI_2 = environ.get('DATABASE_URI_2', "mongodb+srv://username:password@cluster0.jhvfd.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME_2 = environ.get('DATABASE_NAME_2', "TELEGRAM_BOT_INFO")
...
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/Movie_Url_link_downloader/17")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/Movie_Url_link_downloader/17")
